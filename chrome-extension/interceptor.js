...
;(function () {
  ...
  console.log('[Núcleo Comercial] Interceptor ativo.')

  function notify(type, url, body) {
    console.log('[Núcleo Comercial] Notificando:', type, url)
  ...
  window.fetch = async function (input, init) {
    ...
    if (method === 'POST') console.log('[Núcleo Comercial] fetch POST:', url)
  ...
  XMLHttpRequest.prototype.send = function (body) {
    ...
    if (method === 'POST') console.log('[Núcleo Comercial] XHR POST:', url)
